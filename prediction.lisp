...
(defun generate-predictors (ht at &optional params)
  (if (not (null params))
      (loop for x in params collect (cond ((eq x 'a) (get-record ht 'home))
                                          ((eq x 'b) (get-record at 'away))
                                          ((eq x 'c) (get-record ht))
                                          ((eq x 'd) (get-record at))
                                          ((eq x 'e) (get-record ht 'all 3))
                                          ((eq x 'f) (get-record at 'all 3))
                                          ((eq x 'g) (- (get-goals ht 'for) (get-goals ht 'against)))
                                          ((eq x 'h) (- (get-goals at 'for) (get-goals at 'against)))
                                          ((eq x 'i) (get-rank ht))
                                          ((eq x 'j) (get-rank at))))
